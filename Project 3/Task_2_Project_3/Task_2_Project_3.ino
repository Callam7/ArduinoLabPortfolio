//My main extension of this task was that I altered the distance values so that the lights will change more rapidly and respond to closer distances
...
void loop() {
  ...
  if(distance <= 3){                         //if the object is close
  ...
  } else if(6 < distance && distance < 20){  //if the object is a medium distance
