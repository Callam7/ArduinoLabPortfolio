 //mainly changed the servo degree values and the distance values.
 //as well as altered the delay for the buzzer tones.
...
void loop() {
  ...
  if(distance <= 4){                         //if the object is close
    ...
    myservo.write(25);            //move the servo to 45 degrees
    delay(100);                   //wait 100 milliseconds
    
    noTone(buzzerPin);            //turn the buzzer off
    myservo.write(100);           //move the servo to 135 degrees
    delay(100);                   //wait 100 milliseconds
    
    
  } else if(12 < distance && distance < 15){  //if the object is a medium distance
  ...
  delay(150);      //delay 50ms between each reading
}
